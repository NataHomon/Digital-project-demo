(() => {
    ...
    function initSliders() {
        if (document.querySelector(".baner__slider")) new swiper_core_Swiper(".baner__slider", {
            hashNavigation: {
                watchState: true
            },
            ...
            pagination: {
                ...
                renderFraction: function(currentClass, totalClass) {
                    return '<span>0</span><span class="' + currentClass + '"></span>' + '<span class="desh">/</span>' + '<span>0</span><span class="' + totalClass + '"></span>';
                }
            },
            navigation: {
                prevEl: ".baner__button-prev",
                nextEl: ".baner__button-next"
            },
            on: {}
        });
        if (document.querySelector(".proj__slider")) new swiper_core_Swiper(".proj__slider", {
            hashNavigation: {
                watchState: true
            },
